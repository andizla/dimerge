...
Written 2026-09-16 01:50, repo section added 02:10, keybinds block 23:40, start screen block 2026-09-17 11:40. Durable notes also live in the auto-memory file `snowrunner-dimerge.md` (see `MEMORY.md` in the Claude memory folder); this file is the project-local view. Newest session block first.
